...
{
    public class ScriptableSystemViewer2 : EditorWindow
    {
        ...
        // ─────────────────────────────────────────────────────────────
        [MenuItem("Tools/Nameless Games/Scriptable System/Scriptable System Viewer-old")]
        public static ScriptableSystemViewer2 Init()
        {
            Debug.Log("Ehy");
            var window = GetWindow<ScriptableSystemViewer2>(false, "Scriptable System Viewer");
